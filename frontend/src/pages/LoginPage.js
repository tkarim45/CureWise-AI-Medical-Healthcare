...
import { FaHeart, FaLock, FaEye, FaEyeSlash, FaUser } from "react-icons/fa";
        ...
        <div className="w-full max-w-md">
          ...
          <motion.div className="bg-white rounded-xl shadow-lg overflow-hidden" variants={itemVariants}>
            ...
            <div className="bg-gradient-to-r from-primary to-accent p-6 text-center">
              ...
              <p className="text-white/90 mt-1">Sign in to your HealthSync AI account</p>
            </div>
              ...
              <form onSubmit={handleSubmit}>
                ...
                <motion.div className="mb-5" variants={itemVariants}>
                  ...
                  <div className="relative">
                    ...
                    <input type="text" id="username" value={username} onChange={(e) => setUsername(e.target.value)} className="block w-full pl-10 pr-3 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-primary/50 focus:border-primary placeholder-gray-400" placeholder="Enter your username" required disabled={loading} />
                  </div>
                </motion.div>
