      ...
      <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-10">
            <h1 className="text-3xl font-bold text-gray-900 mb-3">Kidney Disease Detection</h1>
            <p className="text-lg text-gray-600">Upload medical images for kidney disease analysis using our AI-powered diagnostic tool</p>
          </div>
            ...
            <div className="p-6 border-b border-gray-200">
              ...
              {showInfo && (
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
                  ...
                  <p className="text-sm text-blue-700">Our AI analyzes medical images (CT scans, ultrasounds) to detect potential kidney abnormalities. Upload clear, well-lit images for best results. This tool assists healthcare professionals but doesn't replace medical diagnosis.</p>
                </div>
              )}
                ...
                {preview ? (
                  ...
                  <>
                    ...
                    <p className="text-gray-500">
                      ...
                      <br />
                      <span className="text-sm text-gray-400">CT scan, ultrasound or other medical images</span>
                    </p>
                  </>
                )}
                    ...
                    <div className="bg-gray-50 rounded-lg p-4">
                      ...
                      <div className="flex items-center">
                        <div className="w-full bg-gray-200 rounded-full h-4">
                          <div className="bg-blue-600 h-4 rounded-full" style={{ width: `${result.confidence * 10}%` }}></div>
                        </div>
                        <span className="ml-3 text-gray-900 font-medium">{(result.confidence * 10).toFixed(1)}%</span>
                      </div>
                    </div>
                  </div>
                </div>
