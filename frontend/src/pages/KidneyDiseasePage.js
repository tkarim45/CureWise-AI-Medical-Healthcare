...
const KidneyDiseasePage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(`${API_URL}/api/kidney-disease-image-classification`, {
        method: "POST",
        body: formData,
        credentials: "include",
  ...
  const handleChatSubmit = async (e) => {
    ...
    setChatInput("");
    try {
      const response = await fetch(`${API_URL}/api/kidney-disease-chat`, {
        method: "POST",
        headers: {
      ...
      <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white shadow-xl rounded-lg overflow-hidden">
            <div className="p-6 border-b border-gray-200">
              <div className="flex items-center justify-between mb-4">
                <h2 className="text-xl font-semibold text-gray-800">Kidney Disease Detection</h2>
              ...
              {showInfo && (
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
                  <h3 className="font-medium text-blue-800 mb-2">About Kidney Disease Detection</h3>
                  <p className="text-sm text-blue-700">Our AI analyzes images to detect potential kidney disease. Upload clear, high-quality images for best results. This tool assists healthcare professionals but does not replace medical diagnosis.</p>
                </div>
              )}
                ...
                {preview ? (
                  ...
                  <>
                    ...
                    <p className="text-gray-500">
                      ...
                      <br />
                      <span className="text-sm text-gray-400">Kidney images (kidneys, etc.)</span>
                    </p>
                  </>
                )}
          ...
          <div className="bg-white shadow-xl rounded-lg overflow-hidden flex flex-col">
            <div className="p-6 border-b border-gray-200">
              <h2 className="text-xl font-semibold text-gray-800 mb-2">Kidney Disease Assistant</h2>
              <p className="text-sm text-gray-500 mb-4">Ask questions about kidney disease conditions, symptoms, or treatments</p>

              <form onSubmit={handleChatSubmit} className="flex gap-2 mb-4">
                <input type="text" value={chatInput} onChange={(e) => setChatInput(e.target.value)} placeholder="Ask about kidney disease symptoms, conditions, treatments..." className="flex-1 border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" disabled={loading} />
            ...
            <div className="flex-1 p-4 bg-gray-50 overflow-y-auto max-h-[500px]">
              {chatHistory.length === 0 ? (
                <div className="h-full flex flex-col items-center justify-center text-center p-8">
                  ...
                  <p className="mt-2 text-sm text-gray-500">Ask me anything about kidney disease symptoms, conditions, or treatments.</p>
                </div>
              ) : (
                <div className="space-y-4">
