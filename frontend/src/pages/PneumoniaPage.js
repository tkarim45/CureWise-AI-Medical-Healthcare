      ...
      <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-10">
            <h1 className="text-3xl font-bold text-gray-900 mb-3">Pneumonia Detection</h1>
            <p className="text-lg text-gray-600">Upload a chest X-ray image for AI-powered pneumonia prediction.</p>
          </div>
            ...
            <div className="p-6 border-b border-gray-200">
              ...
              {showInfo && (
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
                  ...
                  <p className="text-sm text-blue-700">Our AI analyzes chest X-ray images to detect pneumonia. Upload clear, high-quality images for best results. This tool assists healthcare professionals but does not replace medical diagnosis.</p>
                </div>
              )}
                ...
                {preview ? (
                  ...
                  <>
                    ...
                    <p className="text-gray-500">
                      ...
                      <br />
                      <span className="text-sm text-gray-400">Chest X-ray images</span>
                    </p>
                  </>
                )}
