"""Evaluate the pneumonia classifier on a sample image.

Converted from notebooks/pnemonia.ipynb (inference-only; no training code to
port). Paths fixed to weights/ + data/samples/.

Run:  ~/miniconda3/envs/personal/bin/python backend/ml_training/eval_pneumonia.py [image]
"""
...
MODEL_PATH = BACKEND / "weights" / "pneumonia" / "pneumonia.h5"
SAMPLES = BACKEND / "data" / "samples" / "pneumonia"
SIZE = (224, 224)
