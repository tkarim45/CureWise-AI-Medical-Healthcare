"""Evaluate the eye-disease classifier on a sample image.

Converted from notebooks/EyeDisease.ipynb (inference-only; no training code to
port). Paths fixed to weights/ + data/samples/.

Run:  ~/miniconda3/envs/personal/bin/python backend/ml_training/eval_eye_disease.py [image]
"""
...
MODEL_PATH = BACKEND / "weights" / "eye-disease" / "eye_disease.h5"
SAMPLES = BACKEND / "data" / "samples" / "eye-disease"
SIZE = (224, 224)
